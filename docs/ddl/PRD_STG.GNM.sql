...
-- ---------------------------------------------------------------------------
CREATE OR REPLACE TABLE PRD_STG.GNM.SRC_OLIVEYOUNG_NEWARRIVALS (
...
-- ---------------------------------------------------------------------------
-- 8. SRC_COSME_RANKING_NEWARRIVALS
...
-- ---------------------------------------------------------------------------
CREATE OR REPLACE TABLE PRD_STG.GNM.SRC_COSME_RANKING_NEWARRIVALS (
...
GRANT SELECT, INSERT, UPDATE, DELETE, TRUNCATE ON TABLE PRD_STG.GNM.SRC_OLIVEYOUNG_NEWARRIVALS      TO ROLE DEVELOPER_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE, TRUNCATE ON TABLE PRD_STG.GNM.SRC_COSME_RANKING_NEWARRIVALS   TO ROLE DEVELOPER_ROLE;
