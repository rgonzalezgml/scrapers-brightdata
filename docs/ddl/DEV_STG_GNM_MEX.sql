...
GRANT SELECT ON TABLE DEV_STG.GNM_MEX.SRC_ALIBABA_PROV_HIST         TO ROLE STREAMLIT_DEVELOPER;
GRANT SELECT ON TABLE DEV_STG.GNM_MEX.SRC_INDIAMART_PROV_HIST       TO ROLE STREAMLIT_DEVELOPER;
GRANT SELECT ON TABLE DEV_STG.GNM_MEX.SRC_MADEINCHINA_PROV_HIST     TO ROLE STREAMLIT_DEVELOPER;
GRANT SELECT ON TABLE DEV_STG.GNM_MEX.SRC_OLIVEYOUNG_RANK_HIST      TO ROLE STREAMLIT_DEVELOPER;
