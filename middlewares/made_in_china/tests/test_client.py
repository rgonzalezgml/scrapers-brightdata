...
from middlewares.made_in_china import (
    TOOL_SCHEMA,
    MadeInChinaClient,
    MadeInChinaInputs,
    ProductRow,
...
from middlewares.made_in_china.config import (
    DEFAULT_LISTING_URL,
    DEFAULT_MAX_PAGES,
    iso2_for_country,
)
...
async def test_input_translation_default() -> None:
    ...
    assert seed["max_pages"] == DEFAULT_MAX_PAGES
    assert seed["is_rerun"] is False
