...
from gli_scrapers.alibaba import (
    TOOL_SCHEMA,
    AlibabaClient,
    AlibabaInputs,
    ProductRow,
...
from gli_scrapers.alibaba.config import (
    COUNTRY_TO_ISO2,
...
async def test_pydantic_row_model_smoke(snapshot_rows: list[dict]) -> None:
    ...
    from gli_scrapers.alibaba.client import _apply_aliases
    from gli_scrapers.alibaba.models import PRODUCT_ALIASES
