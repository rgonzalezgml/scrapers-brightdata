...
from gli_scrapers.cosmetics_design import (
    TOOL_SCHEMA,
    Article,
...
from gli_scrapers.cosmetics_design.config import (
    ARTICLES_PER_PAGE,
    DEFAULT_SUPPLIER,
    SOURCE_LANDING_URL,
)
from gli_scrapers.cosmetics_design.models import ARTICLE_FIELDS, ARTICLE_LIST_FIELDS
...
async def test_paywall_saturation_threshold() -> None:
    ...
    from gli_scrapers.cosmetics_design.client import _maybe_paywall_saturation
