...
shape of the canonical POC ``gli_scrapers/cosmetics_design/`` and the
multi-entity pattern of ``gli_scrapers/cosme/``.
"""
...
from gli_scrapers.indiamart.tool_schema import TOOL_SCHEMA
