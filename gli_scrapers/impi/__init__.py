...
lookup. See ``gli_scrapers/impi/client.py`` for the rationale.

Public API (consumed by the agents repo / harness):

    >>> from gli_scrapers.impi import trigger, get_result, TOOL_SCHEMA
...
from gli_scrapers.impi.tool_schema import TOOL_SCHEMA
