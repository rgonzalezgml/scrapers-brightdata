// interaction_code_v4 — IndiaMART Stage 1 MCAT listing (Browser worker).
//
...
// Encolar cada URL como seed del Stage 2. `next_stage({url})` es la forma
// canónica de BrightData — `collect()` solo guarda datos pero NO dispara
// el Stage 2. El vendor usaba este loop; v3 lo eliminó por error.
