// parser_code_v7 — Alibaba detail page (Code worker).
//
// Regresión corregida en v7:
//
...
//
// Todos los demás comportamientos son idénticos a v6.
...
// --- Precio (cascada P1–P6). ----------------------------------------------
//
// v7: refactor completo del bloque de precio en 6 funciones nombradas.
// La cascada prueba cada estrategia en orden; la primera que retorna
// price_raw no-null gana. La presencia de .price-item ya NO bloquea las
// estrategias P2–P6 (fix de la regresión R-v6).
//
...
// Probar en orden; detenerse en el primero que produce price_raw.
const strategies = [
...
for (const strategy of strategies) {
    ...
    if (result && result.price_raw) {
        ...
        // incluso si una estrategia anterior ya seteó moq_raw = null.
