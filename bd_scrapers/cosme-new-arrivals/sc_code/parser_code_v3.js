// ============================================================================
// cosme-new-arrivals — sc_code parser_code_v3.js
// ============================================================================
// Cambios vs v2:
//   • Reemplaza .map(fn).get() por .each(fn) en los 3 sitios donde aparece.
//     BrightData Scraper Studio no soporta jQuery .map() — solo .each().
//
...
if (!input.day) {
  ...
  $('table.calendarNaviDay th').each(function (_, el) {
    const $th = $(el);
...
$('div.newProductList').children().each(function (_, el) {
  const $el = $(el);
